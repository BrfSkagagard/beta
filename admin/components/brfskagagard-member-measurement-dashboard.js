    ...
    MemberMeasurement.prototype = {
        ...
        updatePieInfo: function (elements, text, degre, isBig) {
            for (var index = 0; index < elements.length; index++) {
                ...
                if (!isBig) {
                    filler.src = '/resources/img/graph-color-01.png';
                    bigPiece.src = '/resources/img/graph-color-03b.png';
                } else {
                    filler.src = '/resources/img/graph-color-03b.png';
                    bigPiece.src = '/resources/img/graph-color-01.png';
                }
        ...
        updateCostPieInfo: function (elements, text, degre, isBig, isOver) {
            for (var index = 0; index < elements.length; index++) {
                ...
                if (isOver) {
                    if (isBig) {
                        filler.src = '/resources/img/graph-color-04b.png';
                        bigPiece.src = '/resources/img/graph-color-05.png';
                    } else {
                        filler.src = '/resources/img/graph-color-05.png';
                        bigPiece.src = '/resources/img/graph-color-04b.png';
                    }
                } else {
                    if (isBig) {
                        filler.src = '/resources/img/graph-color-06.png';
                        bigPiece.src = '/resources/img/graph-color-04b.png';
                    } else {
                        filler.src = '/resources/img/graph-color-04b.png';
                        bigPiece.src = '/resources/img/graph-color-06.png';
                    }
                }
